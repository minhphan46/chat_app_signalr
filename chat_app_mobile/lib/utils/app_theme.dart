...
class AppTheme {
  static Color gradientColorFrom = const Color(0xff162e4d);
  static Color gradientColorTo = const Color(0xff172e4d);
  ...
  static TextStyle loginHelpStyle = const TextStyle(
